...
| 5 | **X-11.19** · Medium | Converge the environment behaviour, or accept and document | Sync in-request on dev/qa/staging, async over SQS on prod alone. **Closes as a side effect of Tier 2**, which converges both paths on async and changes the folder endpoint from 204 to 202 |
