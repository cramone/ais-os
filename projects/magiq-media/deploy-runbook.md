...
Supersedes the dispatch-only model described in `_archive/plans/deployment-naming/deploy-handoff-tom.md`
...
6. **Smoke test before flipping any gate.** Confirm the deploy end-to-end
   ...
   `_archive/plans/deployment-naming/deploy-handoff-tom.md`, generalized to any newly-bootstrapped
   environment.
