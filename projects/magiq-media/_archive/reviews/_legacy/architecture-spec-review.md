...
- App-code verification — every finding above is spec/design; none has been checked against `D:\source\github\sprbrk-standard\mgq-magiq-media` source beyond what the specs assert.
